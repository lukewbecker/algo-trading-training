# This script is to clean and prepare the kucoin account balances into a dollar figure for each current holding, and finally export the dataframe to a .csv file.
...
# printing out result, and saving to csv.
print(holdings)
